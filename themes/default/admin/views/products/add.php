            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-5">
                    ...
                    <div class="form-group">
                        ...
                        <select name="product_group" id="group" class="form-control select2">
                            <?php foreach($product_group as $group):?>
                                <option value="<?=$group->id;?>"><?=strtoupper($group->group_name);?> (<?=$group->description;?>)</option>
                            <?php endforeach;?>
                        </select>
                    </div>
                    ...
                    <div class="form-group standard dis-none">
                        ...
                        ?>
                        <?= form_dropdown('unit', $pu, set_value('unit', ($product ? $product->unit : $unit->id)), 'class="form-control tip" id="unit" required="required" style="width:100%;"'); ?>
                    </div>
                    <div class="form-group standard">
<!--                        --><?//= lang('default_sale_unit', 'default_sale_unit'); ?>
                        <?php $uopts[''] = lang('select_unit_first'); ?>
                        <?= form_dropdown('default_sale_unit', $uopts, set_value('default_sale_unit', ($product ? $product->unit : $unit->id)), 'class="form-control" style="display:none" id="default_sale_unit" style="width:100%;"'); ?>
                    </div>
                    <div class="form-group standard">
<!--                        --><?//= lang('default_purchase_unit', 'default_purchase_unit'); ?>
                        <?= form_dropdown('default_purchase_unit', $uopts, set_value('default_purchase_unit', ($product ? $product->unit : $unit->id)), 'class="form-control" style="display:none" id="default_purchase_unit" style="width:100%;"'); ?>
                    </div>
                    <div class="form-group standard">
                    ...
                    <div class="<?= $product ? 'text-warning' : '' ?>">
                        ...
                        if (!empty($warehouses)) {
                            if ($product) {
                                ...
                                if($quantity_field){
                                    ?>
                                    <?= form_input('quantity', (isset($_POST['quantity']) ? $_POST['quantity'] : ($product ? $product->quantity : '')), 'class="form-control tip" id="quantity" required="required"') ?>
                                    <?php
                                }
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <label for="extras" class="padding05"><?= lang('installment_fields') ?></label>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="pr_popover_content">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <label for="quantity" class="col-sm-4 control-label"><?= lang('quantity') ?></label>
                        <div class="col-sm-8">
