...
<?php
    $fournisseur = $this->sma->in_group('fournisseurs');
...
<head>
    ...
    <style>
        .loader{width: 20em !important; height:20em !important;}
        .custom_notification{
            position: fixed;
            top: 10px;
            right: 0px;
        ...
        /*.nav.main-menu > li > ul > li > a {*/
            ...
            /*padding-left: 12px;*/
        /*}*/
        /*#sidebar-left ,  .lt td.sidebar-con , .navbar {*/
            /*background-color: #1f262d;*/
        /*}*/
                                ...
                                <li class="dropdown-content">
                                    <div class="scroll-div">
                                        <div class="top-menu-scroll">
                                            <ol class="oe">
                                                <?php foreach ($info as $n) { echo '<li>' . $n->comment . '</li>'; } ?>
                                            </ol>
                                        </div>
                                    </div>
                                </li>
                    ...
                    <?php if (($Owner || $Admin || $GP['reports-quantity_alerts'] || $GP['reports-expiry_alerts']) && ($qty_alert_num > 0 || $exp_alert_num > 0 || $shop_sale_alerts)) {
                        ...
                        <li class="dropdown hidden-sm">
                            <a class="btn blightOrange tip" title="<?= lang('alerts') ?>"
                                ...
                                <span class="black"><?= $qty_alert_num + (($Settings->product_expiry) ? $exp_alert_num : 0) + $shop_sale_alerts + $shop_payment_alerts; ?></span>
                            </a>
                            <ul class="dropdown-menu pull-right">
            ...
            <div id="sidebar-left">
                <div class="sidebar-nav nav-collapse collapse navbar-collapse" id="sidebar_menu">
                    <ul class="nav main-menu">
                        ...
                        if ($Owner || $Admin) {
                            ...
                            <li class="mm_schools">
                                <a class="submenu" href="<?= admin_url('schools'); ?>">
                                    <i class="fa fa-th"></i><span class="text"> <?= lang('schools'); ?></span>
                                </a>
                            </li>
                            ...
                            <li class="mm_shop_settings mm_api_settings">
                                ...
                                <ul>
                                    <li id="installment_settings">
                                        <a href="<?= admin_url('shop_settings/installment_settings') ?>">
                                            <i class="fa fa-cog"></i><span class="text"> <?= lang('installment_settings'); ?></span>
                                        </a>
                                    </li>

                                    <li id="week_deals">
                                        <a href="<?= admin_url('shop_settings/week_deals') ?>">
                                            <i class="fa fa-gift"></i><span class="text"> <?= lang('week_deals'); ?></span>
                                        </a>
                                    </li>

                                    <li id="site_colors" class="<?=($this->router->fetch_method()== 'site_colors')?'active':null;?>">
                                        <a href="<?= admin_url('shop_settings/site_colors') ?>">
                                            <i class="fa fa-adjust"></i><span class="text"> <?= lang('Couleur du site'); ?></span>
                                        </a>
                                    </li>

                                    <li id="font_styles" class="<?=($this->router->fetch_method()== 'font_styles')?'active':null;?>">
                                        <a href="<?= admin_url('shop_settings/font_styles') ?>">
                                            <i class="fa fa-adjust"></i><span class="text"> <?= lang('Style'); ?></span>
                                        </a>
                                    </li>

                                    <li id="shipping_settings">
                                        <a href="<?= admin_url('shop_settings/shipping_settings') ?>">
                                            <i class="fa fa-ambulance"></i><span class="text"> <?= lang('shipping_settings'); ?></span>
                                        </a>
                                    </li>

                                    <li id="digital_fees">
                                        <a href="<?= admin_url('shop_settings/digital_fees') ?>">
                                            <i class="fa fa-money"></i><span class="text"> <?= lang('digital_fees'); ?></span>
                                        </a>
                                    </li>
                                    ...
                                    <li id="shop_settings_slider">
                                        <a href="<?= admin_url('shop_settings/slider') ?>">
                                            <i class="fa fa-file"></i><span class="text"> <?= lang('silder_settings'); ?></span>
                                        </a>
                                    </li>
                                    ...
                                    <li id="shop_settings_sms_settings">
                                        <a href="<?= admin_url('shop_settings/sms_settings') ?>">
                                            <i class="fa fa-cogs"></i><span class="text"> <?= lang('settings').' SMS'; ?></span>
                                        </a>
                                    </li>
                        ...
                        <?php
                            ...
                            <li class="mm_quotes">
                                ...
                                <ul>
                                    <li id="sales_index">
                                        <a class="submenu" href="<?= admin_url('quotes'); ?>">
                                            <i class="fa fa-heart"></i><span class="text"> <?= lang('list_quotes'); ?></span>
                                        </a>
                                    </li>
                        ...
                        <?php if($this->sma->in_group('fournisseurs')):;?>
                            <li id="supplier_slides" class="<?=($this->router->fetch_method()== 'slides')?'active':null;?>">
                                <a href="<?= admin_url('suppliers/slides') ?>">
                                    <i class="fa fa-file"></i>
                                    <span class="text"> <?= lang('slides'); ?></span>
                                </a>
                            </li>

                            <li id="site_colors" class="<?=($this->router->fetch_method()== 'site_colors')?'active':null;?>">
                                <a href="<?= admin_url('suppliers/site_colors') ?>">
                                    <i class="fa fa-adjust"></i>
                                    <span class="text"> <?= lang('couleurs'); ?></span>
                                </a>
                            </li>

                            <li id="font_styles" class="<?=($this->router->fetch_method()== 'font_styles')?'active':null;?>">
                                <a href="<?= admin_url('suppliers/font_styles') ?>">
                                    <i class="fa fa-adjust"></i>
                                    <span class="text"> <?= lang('police_et_style'); ?></span>
                                </a>
                            </li>
                        <?php endif;?>
            ...
            <div id="content">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="custom_notification"></div>