    ...
    <div class="box-content">
       <div class="row">
           <div class="col-sm-3 border-right">
               ...
               <select id="button_content" name="search_button_content" class="form-control sup_setting_item" data-action="update_search_btn_content" value="<?=$settings->search_button_content;?>" data-button="#search">
                   <option value='<i class="fa fa-search"></i>'>Icon</option>
                   <option value="Recherche">Text</option>
               </select>
           </div>
...
<script>
    $(document).on('click','.custom-switch-btn',{passive:true},function () {
        ...
        if(final_state){
            ...
            $.post('<?=base_url('admin/suppliers/font_styles/update_font');?>' , aoData , function (response) {
    ...
    $(document).on('blur','.edit_font_size',{passive:true},function () {
        ...
        $.post('<?=base_url('admin/suppliers/font_styles/update_font_size');?>' , aoData , function (response) {
    ...
    $(document).on('change','[type="range"] , .sup_setting_item',{passive:true},function () {
        ...
        $.post('<?=base_url('admin/suppliers/font_styles/update_settings');?>' , aoData , function (response) {
            show_message('success',response);
        })
    });
