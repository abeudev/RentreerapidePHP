...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-heart"></i><?= lang('quotes') . ' (' . ($warehouse_id ? $warehouse->name : lang('all_warehouses')) . ')'; ?>
        </h2>
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        ...
                        <li>
                            <a href="#" class="bpo" title="<b><?= $this->lang->line('delete_quotes') ?></b>" 
                                ...
                                data-html="true" data-placement="left"><i class="fa fa-trash"></i> <?= lang('delete_quotes') ?>
                            </a>
                        </li>
                    </ul>
                </li>
