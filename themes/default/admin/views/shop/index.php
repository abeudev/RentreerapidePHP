            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <?= lang('display_product_quantity_ajuter', 'display_qty_ajuster'); ?>
                            <?php $dqtyadj = [0 => lang('no'), 1 => lang('yes')]; ?>
                            <?= form_dropdown('display_qty_ajuster', $dqtyadj, set_value('display_qty_ajuster', $shop_settings->display_qty_ajuster), 'class="form-control tip" id="display_qty_ajuster" required="required"'); ?>
                        </div>
                        <div class="form-group">
