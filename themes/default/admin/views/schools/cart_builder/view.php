...
<div id="wrapper">
    <div id="receiptData">
        <div id="receipt-data">
            ...
            <div>
                <p>Ecole : <strong><?=$school->school_name;?></strong></p>
                <p>Classe : <strong><?=$class->level;?></strong></p>
            </div>

            <div class="col-sm-12 text-center border-bottom">
                <h4 style="font-weight:bold;"><?= lang($inv->suspend_note); ?></h4>
            </div>
    ...
    <div id="buttons" style="padding-top:10px; text-transform:uppercase;" class="no-print">
        ...
        <span class="col-xs-12">
            <a class="btn btn-block btn-warning" href="<?= admin_url('schools'); ?>"><?= lang('Retour à la liste des établissements'); ?></a>
        </span>
        <?php endif;?>
