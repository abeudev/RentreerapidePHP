...
<!--                                        --><?//= lang('shipping', 'poshipping'); ?>
                                        <?php echo form_input('shipping', '', 'class="form-control input-tip" style="display:none" id="poshipping"'); ?>
<!--                                        --><?//= lang('payment_term', 'popayment_term'); ?>

                                        <?php echo form_input('payment_term', '', 'class="form-control tip" data-trigger="focus" style="display:none" data-placement="top" title="' . lang('payment_term_tip') . '" id="popayment_term"'); ?>
