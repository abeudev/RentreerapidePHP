...
//                                        'vietnamese'           => 'Vietnamese',
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label" for="grace_period"><?= lang('grace_period'); ?></label>
                                <?= form_input('grace_period', $Settings->grace_period, 'class="form-control tip" required="required" id="grace_period"'); ?>
                            </div>
                        </div>
