    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table width="100%" class="stable">
                ...
                <tr>
                    <td style="border-bottom: 1px solid #DDD;"><h4><?= lang('total_produits'); ?>:</h4></td>
                    <td style="text-align:right;border-bottom: 1px solid #DDD;"><h4>
                            <span class="label label-success"><?=(int)$sales->total_product;?></span> </h4>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="text-align:right;">
                        <h4>
                            <span><strong><?= $this->sma->formatMoney($sales->total); ?></strong></span>
                        </h4>
                    </td>
                </tr>
