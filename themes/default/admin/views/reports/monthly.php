                        ...
                        <tr>
                            ...
                            if (!empty($sales)) {
                                foreach ($sales as $value) {
                                    $array[$value->date] = "<table class='table table-bordered table-hover table-striped table-condensed data' style='margin:0;'><tbody><tr><td>" . $this->lang->line('discount') . '</td></tr><tr><td>' . $this->sma->formatMoney($value->discount) . '</td></tr><tr><td>' . $this->lang->line('shipping') . '</td></tr><tr><td>' . $this->sma->formatMoney($value->shipping) . '</td></tr><tr class="dis-none"><td>' . $this->lang->line('product_tax') . '</td></tr><tr class="dis-none"><td>' . $this->sma->formatMoney($value->tax1) . '</td></tr><tr class="dis-none"><td>' . $this->lang->line('order_tax') . '</td></tr><tr class="dis-none"><td>' . $this->sma->formatMoney($value->tax2) . '</td></tr><tr><td>' . $this->lang->line('total') . '</td></tr><tr><td>' . $this->sma->formatMoney($value->total) . '</td></tr></tbody></table>';
                                }
                                for ($i = 1; $i <= 12; $i++) {
                                    echo '<td width="8.3%">';
                                    if (isset($array[$i])) {
