                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-6">
                            <div class="small-box padding1010 bdarkGreen">
                                ...
                                <p class="text-left"><?= $this->sma->formatMoney($total_received_cash->total_amount) . ' ' . lang('cash') ?><br>
                                     <?= $this->sma->formatMoney($total_received_cc->total_amount) . ' ' . lang('CC') ?><br>
                                     <?= $this->sma->formatMoney($total_received_cheque->total_amount) . ' ' . lang('cheque') ?><br>
                                     <?= $this->sma->formatMoney($total_received_om->total_amount) . ' ' . lang('Orange_Money') ?><br>
                                     <?= $this->sma->formatMoney($total_received_momo->total_amount) . ' ' . lang('Mtn_Mobile_Money') ?><br>
                                     <?= $this->sma->formatMoney($total_received_stripe->total_amount) . ' ' . lang('stripe') ?> </>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="small-box padding1010 borange">
