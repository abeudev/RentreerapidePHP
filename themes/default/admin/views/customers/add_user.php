            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <?php echo form_input('first_name', $first_name, 'class="form-control" id="first_name" required="required" pattern=".{3,10}"'); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <?php echo form_input('last_name', $last_name, 'class="form-control" id="last_name" required="required"'); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <?php echo form_input('phone', $company->phone, 'class="form-control" id="phone"'); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="email" id="email" value="<?=$company->email;?>" autocomplete="off" name="email" class="form-control" required="required"/>
