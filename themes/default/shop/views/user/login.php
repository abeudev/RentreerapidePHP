...
<!--                                            --><?//= lang('company', 'company'); ?>
                                            <?= form_input('company', 'customer_company', 'class="form-control tip" style="display:none" id="company"'); ?>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <?= form_password('password', '', 'class="form-control tip" id="passwordr" required="required"'); ?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <?= form_password('password_confirm', '', 'class="form-control" id="password_confirm" required="required" data-bv-identical="true" data-bv-identical-field="password" data-bv-identical-message="' . lang('pw_not_same') . '"'); ?>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="featured-products">
                                                <div class="product" style="z-index: 1;">
                                                    <div class="details" style="transition: all 100ms ease-out 0s;">
                                                        ...
                                                        <img data-src="<?= productImage($fp->image); ?>" alt="">
