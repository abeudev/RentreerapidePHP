...
class Api_settings extends MY_Controller
{
    ...
    public function getApis()
    {
        ...
        $this->datatables
            ...
            ->from('api_keys')
            ->add_column('Actions', "<div class=\"text-center\"><a href='#' class='tip po' title='<b>" . lang('delete') . "</b>' data-content=\"<p>" . lang('r_u_sure') . "</p><a class='btn btn-danger po-delete' href='" . admin_url('api_settings/delete/$1') . "'>" . lang('i_m_sure') . "</a> <button class='btn po-close'>" . lang('no') . "</button>\"  rel='popover'><i class=\"fa fa-trash\"></i></a></div>", 'id');
