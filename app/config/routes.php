...
$route['library/(:any)'] = 'shop/shop/products/0/0/0/0/$1';
...
$route['payment/(:any)'] = 'shop/payment/$1';
$route['payment/(:any)/(:any)'] = 'shop/payment/$1/$2';
$route['payment/(:any)/(:any)/(:any)'] = 'shop/payment/$1/$2/$3';
$route['payment/(:any)/(:any)/(:any)/(:any)'] = 'shop/payment/$1/$2/$3/$4';
